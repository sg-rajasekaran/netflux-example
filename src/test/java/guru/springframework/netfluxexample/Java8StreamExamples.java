...
public class Java8StreamExamples {
    ...
    @Test
    public void filterAndSortStreamWithFunctionalCop() throws Exception {
        List<String> dogs = Arrays.asList("Vizsla", "Lab", "Golden", "GSP", "Poodle", "Yorkie", "Mutt");
    ...
    public void testGetMax() throws Exception {
        List<Integer> numbers = Arrays.asList(1, 7, 3, 8, 5, 6);
    ...
    public void testSumCollector() throws Exception {
        List<Integer> numbers = Arrays.asList(1, 2, 9, 4, 5, 6);

        Integer numbersSum = numbers.stream().collect(Collectors.summingInt(value -> value));
        System.out.println("Sum:"+ numbersSum);
    }
    ...
    public void testGroupingBy() throws Exception {
        ...
        Map<Integer, Set<String>> groupedMed = dogs.stream().collect(Collectors.groupingBy(String::length, Collectors.toSet()));

        groupedMed.entrySet().stream().forEach(System.out::println);
    }
    ...
    public void testReduction() throws Exception {
        ...
        String reducedString = dogs.stream().reduce((a,b) -> a + " - " + b).get();
